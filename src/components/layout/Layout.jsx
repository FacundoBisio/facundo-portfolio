...
export default function Layout({ children }) {
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 z-[-2] bg-background bg-size-[14px_24px] mask-[radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none" />
